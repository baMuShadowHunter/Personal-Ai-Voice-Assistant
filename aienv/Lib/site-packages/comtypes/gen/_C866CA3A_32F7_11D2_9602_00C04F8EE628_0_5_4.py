...
__all__ = [
    'DISPID_SPAsCount', 'IEnumSpObjectTokens', 'DISPID_SLWsCount',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPRuleFirstElement', 'SDKLCurrentUser',
    'SpeechGrammarRuleStateTransitionType', 'SpInprocRecognizer',
    'DISPID_SRGIsPronounceable', 'SRAExport', 'SGDisplay',
    'DISPIDSPTSI', 'DISPID_SPEAudioSizeBytes', 'SVSFIsFilename',
    'eLEXTYPE_PRIVATE3', 'SPEI_TTS_PRIVATE', 'ISpRecoContext2',
    'SpeechRegistryLocalMachineRoot', 'SSTTDictation',
    'DISPID_SPPChildren', 'SPGS_DISABLED', 'SPAUDIOOPTIONS',
    'SGRSTTWord', 'SP_VISEME_8', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SpeechPhraseAlternate', 'SGPronounciation', 'SPAO_NONE',
    'DISPID_SGRsFindRule', 'ISpeechGrammarRuleStateTransition',
    'SPPS_Noncontent', 'SPAS_STOP', 'DISPID_SRCPause', 'SPEI_VISEME',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRRDiscardResultInfo', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPEsCount', 'SP_VISEME_5', 'DISPID_SGRInitialState',
    'SpeechVisemeFeature', 'SPINTERFERENCE_TOOQUIET',
    'SAFTADPCM_22kHzStereo', 'SREAudioLevel',
    'SpeechCategoryRecoProfiles', 'DISPID_SRRAudio',
    'SAFT44kHz8BitMono', 'SECHighConfidence',
    'DISPID_SpeechCustomStream', 'DISPID_SPPValue',
    'DISPID_SRSetPropertyString', 'SGSEnabled',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPRulesCount',
    'SAFTCCITT_ALaw_22kHzStereo', 'SINoise',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpGrammarBuilder',
    'SVPOver', 'SVP_7', 'SpeechCategoryVoices',
    'DISPID_SDKGetBinaryValue', 'SREBookmark',
    'SWPUnknownWordUnpronounceable',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_RESERVED4',
    'SPPS_RESERVED2', 'SAFT48kHz16BitStereo',
    'SPEI_START_INPUT_STREAM', 'SAFT8kHz8BitMono',
    'SpeechGrammarWordType', 'DISPID_SRGetPropertyString',
    'SAFTGSM610_8kHzMono', 'SREStateChange', 'SPWORDPRONOUNCEABLE',
    'SpNullPhoneConverter', 'SPFM_OPEN_READWRITE',
    'DISPID_SPRuleEngineConfidence', 'ISpLexicon',
    'DISPID_SPAs_NewEnum', 'SpObjectTokenCategory',
    'DISPID_SRSetPropertyNumber', 'SPEI_PHONEME',
    'DISPID_SpeechAudioBufferInfo', 'SPSInterjection',
    'SpeechAudioFormatType', 'ISpeechRecoResult2', 'SPEI_RESERVED1',
    'DISPID_SRCERequestUI', 'SPAS_RUN',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SPELexicalForm',
    'DISPIDSPRG', 'DISPID_SDKGetStringValue', 'eLEXTYPE_PRIVATE13',
    'SVP_21', 'DISPID_SVSInputWordLength',
    'DISPID_SPEDisplayAttributes', 'WAVEFORMATEX',
    'SpStreamFormatConverter', 'ISpStreamFormat',
    'SpCompressedLexicon', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'STSF_FlagCreate', 'SAFT32kHz8BitStereo', 'DISPID_SVPause',
    'SAFT8kHz16BitMono', 'SECFEmulateResult',
    'DISPID_SVSCurrentStreamNumber', 'SPSLMA',
    'SpeechPropertyLowConfidenceThreshold', 'ISpeechRecoGrammar',
    'SpeechEmulationCompareFlags', 'SpInProcRecoContext',
    'SpeechAddRemoveWord', 'SRARoot', 'DISPID_SPAsItem',
    'ISpeechLexiconPronunciation', 'SVP_6', 'SVF_Emphasis',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPSNotOverriden',
    'DISPID_SABIBufferSize', 'ISpeechPhoneConverter',
    'ISpeechAudioStatus', 'DISPID_SGRSTPropertyName',
    'ISpStreamFormatConverter', 'SAFT11kHz16BitMono',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechPhraseRules',
    'DISPID_SVAudioOutput', 'DISPID_SWFEAvgBytesPerSec',
    'SAFTCCITT_ALaw_22kHzMono', 'SGLexical', 'SLTApp',
    'SPPS_RESERVED4', 'STSF_LocalAppData', 'DISPID_SRRTLength',
    'SPAR_High', 'SpLexicon', 'SpeechDisplayAttributes',
    'SPGS_ENABLED', 'DISPID_SRRGetXMLResult', 'eLEXTYPE_PRIVATE19',
    'SDTDisplayText', 'SVSFIsNotXML', 'eLEXTYPE_USER', 'SPWORDTYPE',
    'DISPID_SDKDeleteKey', 'SpeechMicTraining', 'DISPID_SRGCommit',
    'SSSPTRelativeToStart', 'SpeechAudioProperties', 'SpMemoryStream',
    'eLEXTYPE_RESERVED6', 'IStream', 'SBOPause', 'SpCustomStream',
    'SpeechVoiceEvents', 'SPLOADOPTIONS', 'SVP_3',
    'DISPID_SPEAudioSizeTime', 'SREStreamStart', 'SVSFNLPMask',
    'DISPID_SABIEventBias', 'DISPID_SVAudioOutputStream',
    'DISPID_SVVolume', 'SAFTText', 'SDKLDefaultLocation',
    'SPPHRASEELEMENT', 'DISPID_SLWPronunciations', 'SP_VISEME_0',
    'SpMMAudioOut', 'SPEI_SR_PRIVATE', 'SAFT16kHz8BitStereo',
    'SP_VISEME_1', 'SpeechCategoryAudioOut',
    'DISPID_SASCurrentSeekPosition', 'SPPHRASERULE',
    'DISPID_SRCEAdaptation', 'SVP_15', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPRFirstElement', 'eLEXTYPE_PRIVATE16',
    'DISPID_SMSGetData', 'SGRSTTDictation', 'SBONone',
    'DISPIDSPTSI_ActiveLength', 'SpeechRunState', 'DISPID_SRState',
    'ISpeechLexiconWord', 'SDTAll', 'SAFT32kHz16BitStereo',
    'SPEVENTENUM', 'DISPID_SRCBookmark', 'DISPID_SpeechGrammarRule',
    'DISPID_SPRuleConfidence', 'SAFT22kHz16BitMono',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRSTText',
    'DISPID_SGRSTNextState', 'ISpeechWaveFormatEx',
    'DISPID_SOTCDefault', 'SPRST_INACTIVE_WITH_PURGE',
    '_ISpeechRecoContextEvents', 'ISpRecognizer',
    'SpeechTokenKeyFiles', 'SAFT8kHz16BitStereo', 'SPWORDLIST',
    'SAFT16kHz16BitMono', 'DISPID_SVSLastResult',
    ...
    'SPFM_CREATE_ALWAYS', 'DISPID_SLPType',
    'DISPID_SRCRetainedAudioFormat', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SGRSAddWordTransition', 'SPPS_Modifier', 'ISpRecoResult',
    'SpeechRecognizerState', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SAEventHandle', 'SPXRO_SML',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVSpeakStream',
    'DISPID_SRIsUISupported', 'SLOStatic', 'SP_VISEME_6',
    'DISPID_SLPLangId', 'SPINTERFERENCE', 'SVSFDefault',
    'SECFDefault', 'DISPID_SRCERecognitionForOtherContext',
    'SAFT12kHz8BitMono', 'SPBINARYGRAMMAR', 'DISPID_SWFEExtraData',
    'DISPID_SVPriority', 'DISPID_SRStatus', 'ISpeechXMLRecoResult',
    'SECFIgnoreWidth', 'SPSHORTCUTTYPE', 'DISPID_SOTId', 'SVPAlert',
    'SRCS_Disabled', 'SpMMAudioIn', 'SPWT_PRONUNCIATION',
    'DISPID_SRCEHypothesis', 'eLEXTYPE_USER_SHORTCUT',
    'SAFTCCITT_uLaw_11kHzStereo', 'eLEXTYPE_RESERVED10',
    'ISpRecoGrammar2', 'DISPID_SpeechLexiconPronunciation',
    ...
    'DISPID_SVDisplayUI', 'DISPID_SABufferNotifySize',
    'DISPID_SCSBaseStream', 'SRAImport', 'SPPHRASE',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVSpeak',
    'SGLexicalNoSpecialChars', 'SP_VISEME_2', 'DISPID_SLWs_NewEnum',
    'ISpProperties', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRSNumberOfActiveRules', 'SPSNoun', 'SRATopLevel',
    'DISPID_SpeechRecoResult2', 'SP_VISEME_21', 'SP_VISEME_12',
    'ISpRecoCategory', 'ISpeechMMSysAudio', 'SpeechAudioVolume',
    'ISpeechRecoResult', 'DISPID_SBSRead', 'DISPID_SDKEnumValues',
    'DISPID_SVEStreamStart', 'SVSFPurgeBeforeSpeak',
    'eLEXTYPE_PRIVATE14', 'SPGRAMMARWORDTYPE', 'SPFM_OPEN_READONLY',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SGRsAdd',
    'SPEI_PHRASE_START', 'ISpPhraseAlt', 'SSFMOpenForRead',
    'ISpeechPhraseElements', 'DISPID_SRCERecognition',
    'DISPID_SDKOpenKey', 'DISPID_SOTCSetId',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechPhraseReplacement',
    'ISpeechPhraseAlternates', 'SAFTADPCM_8kHzMono',
    'SpeechAudioFormatGUIDWave', 'SPBO_AHEAD', 'DISPID_SpeechAudio',
    'SGDSActive', 'DISPID_SpeechObjectTokens', 'SPEI_VOICE_CHANGE',
    'SPEI_SR_AUDIO_LEVEL', 'ISpeechBaseStream',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPPParent',
    'DISPID_SpeechLexiconProns', 'eLEXTYPE_VENDORLEXICON',
    'SpeechVoicePriority', 'SPCS_DISABLED', 'DISPID_SPPs_NewEnum',
    'SPRST_ACTIVE_ALWAYS', 'SREFalseRecognition',
    'Speech_StreamPos_Asap', 'SP_VISEME_18',
    'DISPID_SpeechRecoContext', 'STCInprocHandler',
    'ISpeechPhraseRule', 'SPINTERFERENCE_NOSIGNAL',
    'SPDKL_CurrentUser', 'DISPID_SPAPhraseInfo', 'SpPhoneConverter',
    'DISPID_SVGetProfiles', 'DISPID_SPEDisplayText',
    'DISPID_SLPsCount', 'DISPID_SRGCmdLoadFromMemory', 'SASStop',
    'SPEI_RECO_STATE_CHANGE', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_RECOGNITION', 'ISpeechFileStream',
    'SGRSTTWildcard', 'SPSEMANTICERRORINFO', 'SPVPRIORITY',
    'DISPID_SVSLastBookmark', 'SPWF_INPUT', 'ISpResourceManager',
    'SPSSuppressWord', 'SSSPTRelativeToEnd',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRCEPhraseStart',
    'DISPID_SRGRecoContext', 'DISPID_SpeechLexiconWord',
    'ISpeechMemoryStream', 'DISPID_SGRSTPropertyValue',
    'eLEXTYPE_PRIVATE12', 'SVSFVoiceMask',
    'DISPID_SPRNumberOfElements', 'SPPHRASEREPLACEMENT',
    'SAFTADPCM_11kHzMono', 'DISPID_SPRuleParent',
    'ISpeechRecoContext', 'DISPID_SRRRecoContext', 'DISPID_SRGRules',
    'SPSFunction', 'SSFMCreateForWrite', 'DISPID_SLGenerationId',
    'DISPID_SpeechRecoResult', 'LONG_PTR', 'ISpeechPhraseAlternate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SBSWrite',
    'DISPID_SRRTStreamTime', 'ISpRecognizer3', 'tagSPPROPERTYINFO',
    'SpeechRecognitionType', 'DISPID_SGRClear', 'SVSFlagsAsync',
    'SVP_1', 'SpeechStreamFileMode', 'SVEPrivate',
    'DISPID_SPRs_NewEnum', 'SPADAPTATIONRELEVANCE', 'SSTTTextBuffer',
    'DISPID_SVVoice', 'DISPID_SRIsShared', 'SPBO_TIME_UNITS',
    'SVSFIsXML', 'DISPID_SRCRetainedAudio', 'SPCS_ENABLED',
    'SPCATEGORYTYPE', 'DISPID_SVGetAudioOutputs', 'IEnumString',
    'DISPID_SPCLangId', 'DISPID_SVEventInterests',
    'DISPID_SpeechRecoContextEvents', 'SAFTCCITT_ALaw_44kHzStereo',
    'IInternetSecurityMgrSite', 'STCLocalServer',
    'ISpeechObjectToken', 'SVP_17', 'SVEViseme', 'SPPARTOFSPEECH',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPAStartElementInResult',
    'SAFTNoAssignedFormat', 'SPTEXTSELECTIONINFO', 'SAFTDefault',
    'DISPID_SPIGetText', 'SpPhoneticAlphabetConverter',
    'SpeechRecoContextState', 'SVEBookmark',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVESentenceBoundary',
    'SpeechCategoryAudioIn', 'SPVPRI_OVER',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechGrammarRuleState',
    'SPPS_SuppressWord', 'DISPID_SVSRunningState', 'SPSHT_Unknown',
    'SAFTADPCM_44kHzMono', 'SPEI_END_SR_STREAM',
    'DISPID_SRGCmdLoadFromResource', 'SPPROPERTYINFO',
    'ISpSerializeState', 'SpeechLoadOption',
    'DISPID_SpeechVoiceStatus', 'DISPID_SMSAMMHandle', 'SVP_19',
    'SRESoundStart', 'DISPID_SPRsItem', 'DISPID_SRAudioInputStream',
    'eLEXTYPE_PRIVATE15', 'DISPID_SLPs_NewEnum', 'DISPID_SLWLangId',
    'SpeechInterference', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPARecoResult', 'SVP_5', 'ISpeechPhraseProperty',
    ...
    'SAFTCCITT_uLaw_8kHzMono', 'SREInterference',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SAFGuid',
    'IInternetSecurityManager', 'SDA_Two_Trailing_Spaces',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRGId', 'SPSHT_NotOverriden', 'SASPause',
    'SPDATAKEYLOCATION', 'ISpeechRecognizer', 'SREAllEvents',
    'STSF_AppData', 'SVSFParseSsml', 'SVSFParseAutodetect',
    'SPEI_SOUND_END', 'SAFTADPCM_11kHzStereo', 'SPEI_MIN_SR',
    'DISPID_SPEsItem', 'DISPID_SPEPronunciation',
    ...
    'SGDSActiveUserDelimited', 'SDTProperty', 'DISPID_SGRsCommit',
    'DISPID_SFSOpen', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SVEStreamEnd', 'SRERecognition', 'DISPID_SWFEChannels',
    'SVP_18', 'DISPID_SVEPhoneme', 'SpeechGrammarTagWildcard',
    'eLEXTYPE_PRIVATE9', 'SPRST_INACTIVE', 'SPSMF_UPS',
    'SPAUDIOSTATUS', 'SVF_None', 'SVSFUnusedFlags',
    'ISpeechGrammarRuleState', 'SpeechBookmarkOptions',
    'DISPID_SVSInputSentencePosition', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SLPsItem', 'SPAUDIOSTATE', 'SVP_4', 'SDTRule',
    'ISpMMSysAudio', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_REQUEST_UI', 'DISPID_SRProfile', 'eLEXTYPE_APP',
    'DISPID_SpeechLexicon', 'DISPID_SRRPhraseInfo',
    'SECFIgnoreKanaType', 'SPCT_SLEEP', 'SPEI_TTS_BOOKMARK',
    'eLEXTYPE_PRIVATE20', 'DISPID_SDKSetBinaryValue', 'SPAS_CLOSED',
    ...
    '_SPAUDIOSTATE', 'SpTextSelectionInformation', 'DISPID_SGRName',
    'SP_VISEME_9', 'SINoSignal', 'SAFTGSM610_22kHzMono',
    'SP_VISEME_10', 'SPRST_ACTIVE', 'SPEVENT',
    'SAFTNonStandardFormat', 'SpeechTokenContext', 'SRTEmulated',
    'SP_VISEME_4', 'SPCONTEXTSTATE', 'SRTSMLTimeout', 'SRSEDone',
    'DISPID_SGRAttributes', 'SVP_13', 'SpeechRegistryUserRoot',
    'DISPID_SDKSetLongValue', 'ISpPhoneticAlphabetSelection',
    'DISPID_SVSPhonemeId', 'DISPID_SLGetGenerationChange', 'SVP_14',
    'SAFT22kHz16BitStereo', 'ISpeechAudio', 'SVP_9', 'SPLEXICONTYPE',
    'SPSHT_EMAIL', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPIAudioSizeTime', 'Speech_Default_Weight',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechPhraseElement',
    'DISPID_SpeechPhraseProperties', 'SPSERIALIZEDPHRASE',
    'SpeechCategoryAppLexicons', 'DISPID_SPPsItem', 'SPWF_SRENGINE',
    'SPBOOKMARKOPTIONS', 'DISPID_SRGetFormat', 'SPEI_HYPOTHESIS',
    'eWORDTYPE_DELETED', 'DISPID_SRRecognizer',
    'DISPID_SOTGetAttribute', 'SGRSTTEpsilon', 'eLEXTYPE_PRIVATE5',
    'DISPID_SAFGetWaveFormatEx', 'SAFT24kHz8BitMono',
    'SpeechDataKeyLocation', 'SpeechRuleState',
    'SpeechDictationTopicSpelling', 'SPGS_EXCLUSIVE',
    'SPEI_RESERVED3', 'SVSFParseMask', 'SPRST_NUM_STATES',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechTokenShellFolder',
    'DISPID_SOTSetId', 'SRAONone', 'DISPID_SDKSetStringValue',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRCVoicePurgeEvent', 'SPVPRI_NORMAL',
    'SpeechRecoEvents', 'SPPS_RESERVED1', 'SpeechWordPronounceable',
    'SpObjectToken', 'SAFT16kHz8BitMono', 'SRESoundEnd',
    'DISPID_SRRTTickCount', 'SGRSTTTextBuffer', 'DISPID_SGRs_NewEnum',
    'SpeechSpecialTransitionType', 'DISPID_SpeechRecognizerStatus',
    'SGSDisabled', 'SPAUDIOBUFFERINFO', 'SpUnCompressedLexicon',
    'SAFT48kHz8BitStereo', 'SPEI_START_SR_STREAM',
    'ISpObjectTokenCategory', 'SAFT12kHz16BitMono', 'SRADynamic',
    'DISPID_SPIProperties', 'DISPID_SRCRequestedUIType',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRGDictationUnload', 'SVP_12', 'SREPropertyStringChange',
    'ISpeechPhraseProperties', 'ISpPhoneticAlphabetConverter',
    'SpeechLexiconType', 'DISPID_SpeechVoiceEvent', 'SASRun',
    'SPBO_NONE', 'SPEI_RESERVED2', 'DISPID_SPIGetDisplayAttributes',
    'SpeechCategoryRecognizers', 'SPSHORTCUTPAIR',
    'DISPID_SLGetPronunciations', 'DISPID_SVResume',
    'SpeechPropertyResponseSpeed', 'DISPID_SpeechMMSysAudio',
    'SPEI_SR_BOOKMARK', 'SVEAudioLevel', 'DISPID_SVGetVoices',
    'SP_VISEME_17', 'ISpeechObjectTokenCategory',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SMSALineId',
    'SAFT48kHz8BitMono', 'eLEXTYPE_PRIVATE11', 'DISPID_SOTDataKey',
    'SPAR_Medium', 'SRTReSent', 'SPEI_INTERFERENCE',
    'DISPID_SVEEnginePrivate', 'ISpVoice', 'SVEVoiceChange',
    'DISPID_SWFEBitsPerSample', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechMemoryStream', 'SpAudioFormat',
    'SPINTERFERENCE_NONE', 'SAFTADPCM_8kHzStereo',
    'ISpeechRecoResultTimes', 'SP_VISEME_19', 'SP_VISEME_3',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCEInterference',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SABufferInfo',
    'SWPKnownWordPronounceable', 'SPCT_DICTATION',
    'DISPID_SVSVisemeId', 'SpeechRetainedAudioOptions',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFT24kHz16BitMono', 'SP_VISEME_13',
    'DISPID_SVIsUISupported', 'SSSPTRelativeToCurrentPosition',
    'SDA_One_Trailing_Space', 'SPRECOGNIZERSTATUS',
    'ISpeechLexiconWords', 'DISPID_SRCEAudioLevel',
    'SPXRO_Alternates_SML', 'DISPID_SpeechPhraseElements',
    'DISPID_SPRuleId', 'SRTStandard', 'Speech_Max_Pron_Length',
    'SpeechVoiceCategoryTTSRate', 'ISpeechPhraseInfoBuilder',
    'DISPID_SBSSeek', 'ISpXMLRecoResult', 'SVP_11', 'SDTLexicalForm',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRSCurrentStreamPosition',
    'SpeechAudioState', 'ISpeechGrammarRules', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_RESERVED7', 'DISPID_SPIRule',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPVISEMES',
    'DISPID_SPERequiredConfidence',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SWFEBlockAlign',
    'SPPS_Unknown', 'eLEXTYPE_RESERVED9', 'SREPhraseStart',
    'eLEXTYPE_PRIVATE7', 'SPWAVEFORMATTYPE',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPEs_NewEnum', 'DISPID_SVRate',
    'DISPID_SpeechAudioStatus', 'SVEWordBoundary',
    'SpeechRecoProfileProperties', 'SAFT24kHz16BitStereo',
    'DISPID_SPPEngineConfidence', 'SPCT_COMMAND',
    'SAFTCCITT_uLaw_8kHzStereo', 'SDKLLocalMachine',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_ADAPTATION',
    'DISPID_SRCRecognizer', 'SAFT12kHz16BitStereo',
    'SpeechCategoryPhoneConverters', 'STSF_CommonAppData',
    'ISpRecoContext', 'DISPID_SpeechXMLRecoResult',
    'DISPIDSPTSI_SelectionLength', 'ISpDataKey',
    'SAFT44kHz16BitStereo', 'DISPID_SRRAudioFormat',
    'SDA_No_Trailing_Space', 'DISPID_SLAddPronunciation',
    'ISpEventSink', 'DISPID_SADefaultFormat',
    'SGDSActiveWithAutoPause', '__MIDL_IWinTypes_0009',
    'SRERecoOtherContext', 'SPRECOCONTEXTSTATUS', 'DISPID_SGRSTType',
    'SPPS_Verb', 'SECLowConfidence', 'SP_VISEME_11', 'SPAS_PAUSE',
    'ISpeechResourceLoader', 'SpeechUserTraining',
    'DISPID_SASNonBlockingIO', 'SPWT_DISPLAY', 'SSFMOpenReadWrite',
    'SPWORD', 'DISPID_SDKCreateKey', 'SPRECORESULTTIMES',
    'SPEI_END_INPUT_STREAM', 'DISPID_SGRsCount',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'STCRemoteServer',
    'SAFT11kHz8BitStereo', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechVoiceStatus', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SLPPhoneIds', 'SP_VISEME_14', 'ISpShortcut',
    'ISpeechRecoResultDispatch', 'DISPID_SPPId',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRDisplayUI',
    'SWPUnknownWordPronounceable', 'ISpEventSource',
    'SAFT44kHz16BitMono', 'DISPID_SGRAddState', 'SpFileStream',
    'SDA_Consume_Leading_Spaces', 'SPEI_MAX_SR', 'SVEAllEvents',
    'ISpeechDataKey', 'SECFIgnoreCase', 'Speech_StreamPos_RealTime',
    'SpPhraseInfoBuilder', 'DISPID_SVGetAudioInputs',
    'DISPID_SpeechObjectToken', 'SASClosed', 'DISPID_SGRSTRule',
    'SpVoice', 'SPXMLRESULTOPTIONS', 'SVSFParseSapi', 'SPSUnknown',
    'eLEXTYPE_MORPHOLOGY', 'SITooSlow',
    'DISPID_SRSSupportedLanguages', 'SITooLoud', 'SREHypothesis',
    'SAFT22kHz8BitMono', 'DISPID_SpeechPhraseBuilder',
    'SpeechGrammarState', 'SPDKL_LocalMachine',
    'DISPID_SRGCmdLoadFromObject', 'SPSVerb', 'SFTInput',
    'SRSEIsSpeaking', 'SpeechPropertyResourceUsage', 'SpWaveFormatEx',
    'SRADefaultToActive', 'SAFT8kHz8BitStereo',
    'SPEI_SR_RETAINEDAUDIO', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechPhraseInfo', 'SGRSTTRule', 'SPDKL_CurrentConfig',
    'SITooQuiet', 'SpeechPartOfSpeech', 'SVF_Stressed',
    'DISPID_SRSCurrentStreamNumber', 'SECNormalConfidence', 'STCAll',
    'SREStreamEnd', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRGDictationLoad', 'DISPID_SOTCEnumerateTokens',
    'UINT_PTR', 'SITooFast', 'eLEXTYPE_PRIVATE2', 'DISPID_SPPsCount',
    'eLEXTYPE_PRIVATE10', 'SPEI_RESERVED5',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SVStatus',
    'SpeechTokenKeyUI', 'DISPID_SOTCGetDataKey', 'SpeechFormatType',
    'DISPID_SRCEFalseRecognition', 'ISpPhoneConverter', 'SVP_10',
    'DISPID_SOTIsUISupported', 'SpeechDiscardType', 'DISPID_SVEWord',
    'DISPID_SLPPartOfSpeech', 'SRSActive', 'ISpeechPhraseInfo',
    'DISPID_SRCEventInterests', 'SAFTCCITT_ALaw_8kHzStereo',
    'SP_VISEME_15', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SWTAdded', 'SRSInactive', 'SDTAudio', 'SGDSInactive',
    'SAFT44kHz8BitStereo', 'DISPID_SGRSAddRuleTransition', 'SVP_2',
    'SpeechGrammarTagDictation', 'SPAR_Low', 'DISPID_SPISaveToMemory',
    'SpeechWordType', 'SPDKL_DefaultLocation',
    'DISPID_SRRSetTextFeedback', 'SAFT48kHz16BitMono',
    'SPPHRASEPROPERTY', 'DISPID_SRCEEndStream', 'SVP_16',
    'SPFM_NUM_MODES', 'SPSHT_OTHER', 'SFTSREngine',
    'SAFTCCITT_uLaw_11kHzMono', 'SPCT_SUB_DICTATION',
    'DISPID_SGRSTsCount', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPIGrammarId', 'DISPID_SRCEEnginePrivate', 'SRERequestUI',
    'ISpObjectToken', 'SAFT32kHz16BitMono', 'SPSERIALIZEDRESULT',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCCreateGrammar',
    'SPPS_NotOverriden', 'SAFT32kHz8BitMono',
    'DISPID_SPIReplacements', 'SpNotifyTranslator', 'ISpeechVoice',
    'DISPID_SGRsItem', 'DISPID_SPPNumberOfElements',
    'DISPID_SAVolume', 'ISequentialStream', 'SpResourceManager',
    'SRCS_Enabled', 'SPEI_UNDEFINED',
    'DISPID_SOTRemoveStorageFileName', 'SDKLCurrentConfig',
    'DISPID_SBSFormat', 'SpeechAudioFormatGUIDText',
    'DISPID_SPCIdToPhone', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SVWaitUntilDone', 'SRSActiveAlways', 'SPLO_STATIC',
    'DISPID_SPEEngineConfidence', 'SPCT_SUB_COMMAND',
    'eLEXTYPE_PRIVATE6', 'ISpObjectWithToken', 'DISPID_SRCResume',
    'DISPID_SPIEngineId', 'DISPID_SVSLastBookmarkId',
    'SPEVENTSOURCEINFO', 'DISPID_SOTGetStorageFileName',
    'SPPS_Function', 'DISPID_SpeechAudioFormat',
    'DISPID_SpeechPhraseRule', 'SSTTWildcard',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPRsCount',
    'SPRULESTATE', 'SAFT11kHz16BitStereo', 'DISPID_SRCEBookmark',
    'SVP_20', 'DISPID_SRGReset', 'SPSTREAMFORMATTYPE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'Speech_Max_Word_Length',
    'DISPID_SPRText', 'DISPID_SGRSTs_NewEnum', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpPhrase',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPILanguageId',
    'DISPID_SPPFirstElement', 'SPRS_ACTIVE', 'SVEStartInputStream',
    'SpeechGrammarTagUnlimitedDictation', 'SPPS_LMA',
    'SVSFPersistXML', 'ISpeechGrammarRule', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SASetState', 'SVSFNLPSpeakPunc', 'tagSTATSTG',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SOTDisplayUI',
    'SAFT22kHz8BitStereo', 'DISPID_SABIMinNotification',
    'SDTReplacement', 'DISPID_SAFType', 'DISPID_SVEBookmark',
    'DISPID_SVSkip', 'SPBO_PAUSE', 'DISPID_SOTsCount',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SOTsItem',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPFILEMODE',
    'ISpeechLexicon', 'DISPID_SVSpeakCompleteEvent',
    'SPINTERFERENCE_NOISE', 'SP_VISEME_16',
    'ISpeechPhraseReplacements', 'STCInprocServer', 'DISPID_SLWWord',
    'ISpRecoGrammar', 'DISPID_SPIStartTime', 'DISPID_SOTCId',
    'DISPID_SPRuleNumberOfElements', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechDataKey', 'SWTDeleted', 'SPLO_DYNAMIC',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPPName',
    'DISPID_SpeechRecognizer', 'SpStream', 'ISpeechRecognizerStatus',
    'SAFT16kHz16BitStereo', 'SpSharedRecognizer', 'ISpAudio',
    'SRAORetainAudio', 'DISPID_SRRSpeakAudio', 'SRAInterpreter',
    'SpMMAudioEnum', '_ISpeechVoiceEvents',
    'SpeechTokenKeyAttributes', 'SPRECOSTATE', 'SGSExclusive',
    'SPSModifier', 'DISPID_SLPSymbolic', 'SpShortcut',
    'DISPID_SGRsDynamic', 'DISPID_SpeechFileStream',
    'SPPS_Interjection', 'SPEI_SOUND_START',
    'DISPID_SVSInputSentenceLength', 'SAFT11kHz8BitMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPRulesItem',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRSAudioStatus',
    'SVPNormal', 'DISPID_SRAudioInput', 'eWORDTYPE_ADDED',
    'SPAO_RETAIN_AUDIO', 'SVEEndInputStream', 'SDTAlternates',
    'SpeechAllElements', 'SINone', 'SVEPhoneme',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRCState',
    'ISpNotifyTranslator', 'ISpeechPhraseElement',
    'ISpeechAudioFormat', 'SPPS_RESERVED3', 'DISPID_SRCVoice',
    'DISPID_SPACommit', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SOTCategory', 'SpeechEngineConfidence', 'ISpStream',
    'DISPID_SVEViseme', 'DISPID_SFSClose', 'DISPID_SVEAudioLevel',
    'SPWORDPRONUNCIATION', 'SREAdaptation', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SAStatus', 'SpeechRuleAttributes',
    'DISPID_SRGDictationSetState', 'DISPID_SOTRemove',
    'SDTPronunciation', 'DISPID_SGRSAddSpecialTransition',
    'SSFMCreate', 'DISPID_SGRSTsItem', 'DISPID_SPCPhoneToId',
    'DISPID_SGRAddResource', 'SPPS_Noun', 'DISPID_SMSADeviceId',
    'ISpeechTextSelectionInformation', 'SpeechEngineProperties',
    'SAFTGSM610_11kHzMono', 'SVESentenceBoundary', 'SPWT_LEXICAL',
    'ISpNotifySink', 'DISPID_SGRSRule', 'SpeechVisemeType',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechVoice',
    'DISPID_SOTs_NewEnum', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SWFEFormatTag', 'DISPID_SPIElements',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFTADPCM_22kHzMono',
    'DISPID_SMSSetData', 'SVP_8', 'SPVOICESTATUS',
    'DISPID_SPRuleName', 'DISPID_SLGetWords', 'DISPID_SLWType',
    'ISpeechGrammarRuleStateTransitions', 'ISpNotifySource',
    'DISPID_SRGState', 'DISPID_SDKGetlongValue',
    'SRSInactiveWithPurge', 'DISPID_SRGetRecognizers',
    'DISPID_SVAlertBoundary', 'DISPID_SGRId', 'SPEI_MIN_TTS',
    'SPRS_INACTIVE', 'SRTExtendableParse', 'SPRULE', 'SPVPRI_ALERT',
    'DISPID_SGRSTPropertyId', 'SPAR_Unknown', 'DISPID_SPPConfidence',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechGrammarRules',
    'DISPID_SVEVoiceChange', 'SLTUser', 'ISpRecognizer2',
    'SPFM_CREATE', 'SPEI_RESERVED6', 'eLEXTYPE_PRIVATE1',
    'SpeechTokenValueCLSID', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SRTAutopause', 'DISPID_SREmulateRecognition',
    'DISPID_SDKDeleteValue', 'SPINTERFERENCE_TOOSLOW',
    'SPSHORTCUTPAIRLIST', 'ISpeechPhraseRules',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SpSharedRecoContext',
    'SVP_0', 'DISPID_SOTCreateInstance',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRRAlternates',
    'SPSEMANTICFORMAT', 'SP_VISEME_7', 'SP_VISEME_20',
    '_RemotableHandle', 'SAFTCCITT_ALaw_8kHzMono', 'SPEI_MAX_TTS',
    'ISpeechLexiconPronunciations', 'SpeechVoiceSpeakFlags',
    'SREPrivate', 'DISPID_SRRTimes', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPRDisplayAttributes', 'SREPropertyNumChange',
    'DISPID_SASState', 'DISPID_SVSInputWordPosition',
    'DISPID_SGRSTransitions', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCEStartStream',
    'DISPID_SRCESoundStart'
]

_check_version('1.2.0', 1416557615.400811)
