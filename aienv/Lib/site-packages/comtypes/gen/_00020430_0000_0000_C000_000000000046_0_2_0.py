...
__all__ = [
    'OLE_XPOS_PIXELS', 'Color', 'Gray', 'Unchecked',
    'OLE_XPOS_CONTAINER', 'OLE_YPOS_HIMETRIC', 'IFontEventsDisp',
    'FONTSIZE', 'FONTSTRIKETHROUGH', 'Default', 'StdPicture',
    'OLE_YPOS_CONTAINER', 'OLE_XSIZE_PIXELS', 'OLE_YPOS_PIXELS',
    'Picture', 'Monochrome', 'OLE_XPOS_HIMETRIC',
    'OLE_XSIZE_CONTAINER', 'FONTITALIC', 'FONTNAME',
    'OLE_ENABLEDEFAULTBOOL', 'IPictureDisp', 'OLE_HANDLE', 'Font',
    'FONTBOLD', 'OLE_YSIZE_PIXELS', 'IFontDisp', 'IFont',
    'OLE_CANCELBOOL', 'OLE_YSIZE_CONTAINER', 'OLE_TRISTATE',
    'FONTUNDERSCORE', 'StdFont', 'OLE_OPTEXCLUSIVE',
    'OLE_YSIZE_HIMETRIC', 'LoadPictureConstants', 'FontEvents',
    'VgaColor', 'Checked', 'OLE_COLOR', 'OLE_XSIZE_HIMETRIC',
    'IPicture'
]

_check_version('1.2.0', 1377171877.807966)
